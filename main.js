...
let projects = [
  {
    image: 'textures/Shooting-Game.jpg',
    url: 'https://somnathkaushik.github.io/Shotting-Game/',
  },
  {
    image: 'textures/Calculator.jpg',
    url: 'https://somnathkaushik.github.io/Utility-Calculator/',
  },
  {
    image: 'textures/Crud.jpg',
    url: 'https://github.com/somnathkaushik/crudexample',
  },
  {
    image: 'textures/Weather.jpg',
    url: 'https://somnathkaushik.github.io/Weather-App/',
  },
  {
    image: 'textures/Drawing.jpg',
    url: 'https://somnathkaushik.github.io/drawing-app/',
  },
  {
    image: 'textures/Github-Analytic-Dashboard.jpg',
    url: 'https://662e8ab46a9762f668b37db2--githubanalyticdashboard.netlify.app/',
  },
  {
    image: 'textures/Grofers.jpg',
    url: 'https://somnathkaushik.github.io/Grofers-Organic-web/',
  },
  {
    image: 'textures/Chase_The_Rabbit.jpg',
    url: 'https://somnathkaushik.github.io/Chase_The_Rabbit/',
  },
  {
    image: 'textures/Parking-Management-System1.jpg',
    url: 'https://somnathkaushik.github.io/Parking-Management-System/',
  },
  {
    image: 'textures/Inexia.jpg',
    url: 'https://somnathkaushik.github.io/inexia-web/',
  },
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('SOMNATH KAUSHIK', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
...
function projectsMenuListener() {
  ...
  projects.forEach((project, i) => {
    ...
    const geometry = new THREE.PlaneGeometry(0.61, 0.35);
    ...
    projectPlane.position.set(
      0.3 + colIndex * 0.8, // Adjusted for proper horizontal spacing
      1 - rowIndex * 0.5,   // Adjusted for proper vertical spacing
      -1.15
    );
    projectPlane.scale.set(0, 0, 0);
    // mesh & y vars needed for animation
    projects[i].mesh = projectPlane;
    projects[i].y = 1 - rowIndex * 0.4;
